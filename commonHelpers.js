import{A as G,S as q,N as M,M as ce,K as ie,i as Y,a as ae}from"./assets/vendor-Diy7lgC5.js";(function(){const t=document.createElement("link").relList;if(t&&t.supports&&t.supports("modulepreload"))return;for(const r of document.querySelectorAll('link[rel="modulepreload"]'))o(r);new MutationObserver(r=>{for(const n of r)if(n.type==="childList")for(const i of n.addedNodes)i.tagName==="LINK"&&i.rel==="modulepreload"&&o(i)}).observe(document,{childList:!0,subtree:!0});function s(r){const n={};return r.integrity&&(n.integrity=r.integrity),r.referrerPolicy&&(n.referrerPolicy=r.referrerPolicy),r.crossOrigin==="use-credentials"?n.credentials="include":r.crossOrigin==="anonymous"?n.credentials="omit":n.credentials="same-origin",n}function o(r){if(r.ep)return;r.ep=!0;const n=s(r);fetch(r.href,n)}})();function le(e,t){e.forEach(s=>{if(s.isIntersecting){const o=s.target;o.dataset.src&&(o.src=o.dataset.src),o.classList.remove("lazy-bg"),t.unobserve(o)}})}const ue=document.querySelectorAll(".lazy-bg"),de=new IntersectionObserver(le);ue.forEach(e=>de.observe(e));const g=(e,t=1e3)=>{const s=document.getElementById(e);if(!s)return;const o=window.scrollY,r=s.getBoundingClientRect().top+o,n=performance.now(),i=a=>{const p=a-n,S=Math.min(p/t,1);window.scrollTo(0,o+(r-o)*B(S)),p<t&&requestAnimationFrame(i)},B=a=>a<.5?2*a*a:-1+(4-2*a)*a;requestAnimationFrame(i)},I=document.querySelector(".js-header-menu-btn"),j=document.querySelector(".js-header-menu"),C=document.querySelector(".js-header-order-link");I&&I.addEventListener("click",Z);j&&j.addEventListener("click",pe);C&&C.addEventListener("click",me);function Z(){j&&j.classList.toggle("isopen")}function pe(e){e.preventDefault();const t=e.target;if(!t.matches("a"))return;const s=t.getAttribute("href").substring(1);g(s),Z()}function me(e){e.preventDefault();const t=e.target;if(!t.matches("a"))return;const s=t.getAttribute("href").substring(1);g(s)}const R=document.querySelector(".js-header-mobile-menu-btn"),Q=document.querySelector(".js-mobile-menu"),_=document.querySelector(".js-mobile-menu-close-btn"),A=document.querySelector(".js-mobile-menu-nav"),T=document.querySelector(".js-mobile-menu-order");R&&R.addEventListener("click",fe);_&&_.addEventListener("click",J);A&&A.addEventListener("click",X);T&&T.addEventListener("click",X);function fe(){Q.classList.add("is-open")}function J(){Q.classList.remove("is-open")}function X(e){e.preventDefault();const t=e.target;if(!t.matches("a"))return;const s=t.getAttribute("href").substring(1);g(s),J()}new G(".accordion-container",{duration:500,openOnInit:[0]});const u=new q(".about-skills-container",{modules:[M],slidesPerView:2,spaceBetween:2,loop:!0,navigation:{nextEl:".about-arrow-btn-next"},speed:700,effect:"coverflow",breakpoints:{768:{slidesPerView:3,spaceBetween:2},1440:{slidesPerView:6,spaceBetween:2}}});u.on("init",ee);u.on("slideChange",ee);function ee(){if(!u||!u.slides)return;u.slides.forEach(t=>{t.classList.remove("active")});const e=u.slides[u.activeIndex];e&&e.classList.add("active")}new G(".faq-acc-container");const O=document.querySelector(".js-project-order");O&&O.addEventListener("click",ve);function ve(e){e.preventDefault();const t=e.target;if(!t.matches("a"))return;const s=t.getAttribute("href").substring(1);g(s)}function ge(e=[]){return e.reduce((t,{url1x:s,url2x:o})=>t+`
      ...
      `,"")}const be=async(e,t)=>{const s=ge(e);t.innerHTML="",t.insertAdjacentHTML("beforeend",s)},we="/alex-template-portfolio/assets/project01@1x-Ye2u9QvY.webp",he="/alex-template-portfolio/assets/project01@2x-CGnU-NZM.webp",xe="/alex-template-portfolio/assets/project02@1x-dj219-w_.webp",je="/alex-template-portfolio/assets/project02@2x-R_GplPUq.webp",ye="/alex-template-portfolio/assets/project03@1x-CuhbSDYE.webp",Le="/alex-template-portfolio/assets/project03@2x-DFdgcKJ5.webp",Se="/alex-template-portfolio/assets/project04@1x-Doff4Zlc.webp",Ee="/alex-template-portfolio/assets/project04@2x-D8suiMQa.webp",qe="/alex-template-portfolio/assets/project05@1x-NId4RxqZ.webp",Me="/alex-template-portfolio/assets/project05@2x-wvuiV8Po.webp",ke="/alex-template-portfolio/assets/project06@1x-C_lFZmue.webp",Pe="/alex-template-portfolio/assets/project06@2x-DCqSTG3_.webp",Be="/alex-template-portfolio/assets/project07@1x-B3QnrJNm.webp",Ie="/alex-template-portfolio/assets/project07@2x-C0-TBLLl.webp",Ce="/alex-template-portfolio/assets/project08@1x-4Vi569Pq.webp",Re="/alex-template-portfolio/assets/project08@2x-DDEYTNWW.webp",_e="/alex-template-portfolio/assets/project09@1x-BaB1ldRA.webp",Ae="/alex-template-portfolio/assets/project09@2x-uHr6DaSI.webp",te=[{url1x:we,url2x:he},{url1x:xe,url2x:je},{url1x:ye,url2x:Le},{url1x:Se,url2x:Ee},{url1x:qe,url2x:Me},{url1x:ke,url2x:Pe},{url1x:Be,url2x:Ie},{url1x:Ce,url2x:Re},{url1x:_e,url2x:Ae}];let w;const se=document.querySelector(".projects-list");se&&Te();async function Te(){try{await be(te,se),w=new q(".projects-swiper-container",{modules:[M,ce,ie],slidesPerView:1,spaceBetween:34,loop:!1,navigation:{nextEl:".projects-btn-next",prevEl:".projects-btn-prev"},speed:1e3,effect:"coverflow",keyboard:{enabled:!0,onlyInViewport:!0},on:{init:$,slideChange:$},touchEventsTarget:"wrapper",simulateTouch:!0,touchRatio:1,touchAngle:45})}catch(e){console.log(e.message)}}function $(){if(!w)return;const e=document.querySelector(".projects-btn-prev"),t=document.querySelector(".projects-btn-next");w.isBeginning?e.disabled=!0:e.disabled=!1,w.isEnd?t.disabled=!0:t.disabled=!1}function Oe(e=[]){const t=(i=0)=>[...e.slice(i),...e.slice(0,i)].reduce((a,{url1x:p,url2x:S})=>a+`<li>        
  ...
  `}const $e=async(e,t)=>{const s=Oe(e);t.innerHTML="",t.insertAdjacentHTML("beforeend",s)},Ne=document.querySelector(".covers-marquee");$e(te,Ne);function De(e=[]){return!e||e.length===0?"":e.reduce((t,{_id:s,author:o="Anonymous",avatar_url:r="default-avatar.png",review:n="No review provided"})=>t+`
      ...
      `}const tt=async(e,t)=>{const s=et(e);t.innerHTML="",t.insertAdjacentHTML("beforeend",s)},st=e=>/^[\w.-]+@[a-zA-Z\d.-]+\.[a-zA-Z]{2,7}$/.test(e),F="Invalid email, try again",rt="Please, enter email",ot="Please, enter comment",nt="Escape",ct=e=>{e.innerHTML=""};let m=document.querySelector(".modal-backdrop");m&&m.addEventListener("click",at);let E;function it(){m.classList.add("is-open"),window.addEventListener("keydown",ne),E=document.querySelector(".modal-close-btn"),E&&E.addEventListener("click",k)}function ne(e){e.code===nt&&k()}function at(e){e.currentTarget===e.target&&k()}function k(e){window.removeEventListener("keydown",ne),m.classList.remove("is-open"),ct(m)}document.addEventListener("DOMContentLoaded",Ge);const f=document.querySelector(".footer-form"),c=f.querySelector(".footer-email"),l=f.querySelector(".footer-comment"),lt=document.querySelector(".footer-button"),d=document.querySelector(".footer-email-error"),v=document.querySelector(".footer-comment-error"),K=document.querySelector(".js-footer-scroll-up");K&&K.addEventListener("click",()=>{g("id-hero",3e3)});const y=document.querySelector(".footer-email-success");f&&f.addEventListener("submit",dt);const ut=[c,l];ut.forEach(e=>{e&&(e.addEventListener("input",pt),e.addEventListener("input",P),e.addEventListener("keydown",W),e.addEventListener("focus",W))});async function dt(e){e.preventDefault();const t=H(c);if(!t){b(d,c,rt);return}const s=H(l);if(!s){b(v,l,ot);return}if(!st(t)){b(d,c,F);return}const o={email:t,comment:s};try{const r=await oe.post("requests",o);r&&r.status>=200&&r.status<300&&(await tt(r.data,document.querySelector(".modal-backdrop")),re("Success!"),it(),U(c),U(l),y&&y.classList.add("visible"),c&&c.classList.add("success"),f.reset())}catch{b(d,c,F)}finally{P()}}function P(){lt.disabled=!c.value.trim()||!l.value.trim()}function pt(){d&&d.classList.remove("visible"),v&&v.classList.remove("visible"),c&&c.classList.remove("error"),l&&l.classList.remove("error")}function W(){d&&d.classList.remove("visible"),v&&v.classList.remove("visible"),y&&y.classList.remove("visible"),c&&c.classList.remove("error"),l&&l.classList.remove("error"),c&&c.classList.remove("success")}function b(e,t,s){e&&e.classList.add("visible"),t&&t.classList.add("error"),h(s)}P();

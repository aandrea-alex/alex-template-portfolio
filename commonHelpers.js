import{A as G,S as q,N as P,K as k,i as ce,a as ie}from"./assets/vendor-CZdjGj8m.js";(function(){const t=document.createElement("link").relList;if(t&&t.supports&&t.supports("modulepreload"))return;for(const r of document.querySelectorAll('link[rel="modulepreload"]'))o(r);new MutationObserver(r=>{for(const n of r)if(n.type==="childList")for(const i of n.addedNodes)i.tagName==="LINK"&&i.rel==="modulepreload"&&o(i)}).observe(document,{childList:!0,subtree:!0});function s(r){const n={};return r.integrity&&(n.integrity=r.integrity),r.referrerPolicy&&(n.referrerPolicy=r.referrerPolicy),r.crossOrigin==="use-credentials"?n.credentials="include":r.crossOrigin==="anonymous"?n.credentials="omit":n.credentials="same-origin",n}function o(r){if(r.ep)return;r.ep=!0;const n=s(r);fetch(r.href,n)}})();function le(e,t){e.forEach(s=>{if(s.isIntersecting){const o=s.target;o.dataset.src&&(o.src=o.dataset.src),o.classList.remove("lazy-bg"),t.unobserve(o)}})}const ae=document.querySelectorAll(".lazy-bg"),ue=new IntersectionObserver(le);ae.forEach(e=>ue.observe(e));const h=(e,t=1e3)=>{const s=document.getElementById(e);if(!s)return;const o=window.scrollY,r=s.getBoundingClientRect().top+o,n=performance.now(),i=l=>{const m=l-n,y=Math.min(m/t,1);window.scrollTo(0,o+(r-o)*_(y)),m<t&&requestAnimationFrame(i)},_=l=>l<.5?2*l*l:-1+(4-2*l)*l;requestAnimationFrame(i)},I=document.querySelector(".js-header-menu-btn"),p=document.querySelector(".js-header-menu"),R=document.querySelector(".js-header-order-link"),C=document.querySelector(".header-fixed");I&&p&&(I.addEventListener("click",()=>{p.classList.toggle("isopen")}),p.addEventListener("click",J));R&&R.addEventListener("click",J);function J(e){e.preventDefault();const t=e.target.closest("a");if(!t)return;const s=t.getAttribute("href").substring(1);h(s),p&&p.classList.contains("isopen")&&p.classList.remove("isopen")}window.addEventListener("scroll",()=>{window.scrollY>50?C.classList.add("onscroll"):C.classList.remove("onscroll")});const A=document.querySelector(".js-header-mobile-menu-btn"),Q=document.querySelector(".js-mobile-menu"),T=document.querySelector(".js-mobile-menu-close-btn"),D=document.querySelector(".js-mobile-menu-nav"),$=document.querySelector(".js-mobile-menu-order");A&&A.addEventListener("click",de);T&&T.addEventListener("click",X);D&&D.addEventListener("click",ee);$&&$.addEventListener("click",ee);function de(){Q.classList.add("is-open")}function X(){Q.classList.remove("is-open")}function ee(e){e.preventDefault();const t=e.target;if(!t.matches("a"))return;const s=t.getAttribute("href").substring(1);h(s),X()}new G(".accordion-container",{duration:500,openOnInit:[0]});const u=new q(".about-skills-container",{modules:[P,k],slidesPerView:2,spaceBetween:2,loop:!0,navigation:{nextEl:".about-arrow-btn-next"},keyboard:{enabled:!0,onlyInViewport:!0},speed:700,effect:"slide",breakpoints:{768:{slidesPerView:3,spaceBetween:2},1440:{slidesPerView:6,spaceBetween:2}}});u.on("init",te);u.on("slideChange",te);function te(){if(!u||!u.slides)return;u.slides.forEach(t=>{t.classList.remove("active")});const e=u.slides[u.activeIndex];e&&e.classList.add("active")}new G(".faq-acc-container");const V=document.querySelector(".js-project-order");V&&V.addEventListener("click",pe);function pe(e){e.preventDefault();const t=e.target;if(!t.matches("a"))return;const s=t.getAttribute("href").substring(1);h(s)}function me(e=[]){return e.reduce((t,{url1x:s,url2x:o})=>t+`
      ...
      `,"")}const fe=async(e,t)=>{const s=me(e);t.innerHTML="",t.insertAdjacentHTML("beforeend",s)},ve="/alex-template-portfolio/assets/project13@1x-D5Ae1P1v.webp",xe="/alex-template-portfolio/assets/project13@2x-D8klBtoi.webp",be="/alex-template-portfolio/assets/project11@1x-ticSGbVE.webp",ge="/alex-template-portfolio/assets/project11@2x-BNlS8ZLJ.webp",we="/alex-template-portfolio/assets/project12@1x-DX7EZF19.webp",je="/alex-template-portfolio/assets/project12@2x-D5j4c6uV.webp",he="/alex-template-portfolio/assets/project01@1x-Ye2u9QvY.webp",Le="/alex-template-portfolio/assets/project01@2x-CGnU-NZM.webp",ye="/alex-template-portfolio/assets/project02@1x-dj219-w_.webp",Se="/alex-template-portfolio/assets/project02@2x-R_GplPUq.webp",Ee="/alex-template-portfolio/assets/project03@1x-CuhbSDYE.webp",qe="/alex-template-portfolio/assets/project03@2x-DFdgcKJ5.webp",Pe="/alex-template-portfolio/assets/project04@1x-Doff4Zlc.webp",ke="/alex-template-portfolio/assets/project04@2x-D8suiMQa.webp",Me="/alex-template-portfolio/assets/project05@1x-NId4RxqZ.webp",Be="/alex-template-portfolio/assets/project05@2x-wvuiV8Po.webp",_e="/alex-template-portfolio/assets/project06@1x-C_lFZmue.webp",Ie="/alex-template-portfolio/assets/project06@2x-DCqSTG3_.webp",Re="/alex-template-portfolio/assets/project07@1x-B3QnrJNm.webp",Ce="/alex-template-portfolio/assets/project07@2x-C0-TBLLl.webp",Ae="/alex-template-portfolio/assets/project08@1x-4Vi569Pq.webp",Te="/alex-template-portfolio/assets/project08@2x-DDEYTNWW.webp",De="/alex-template-portfolio/assets/project09@1x-BaB1ldRA.webp",$e="/alex-template-portfolio/assets/project09@2x-uHr6DaSI.webp",Ve="/alex-template-portfolio/assets/project10@1x-D4mJW1Ez.webp",Ne="/alex-template-portfolio/assets/project10@2x-D6jge__s.webp",se=[{url1x:ve,url2x:xe},{url1x:be,url2x:ge},{url1x:we,url2x:je},{url1x:he,url2x:Le},{url1x:ye,url2x:Se},{url1x:Ee,url2x:qe},{url1x:Pe,url2x:ke},{url1x:Me,url2x:Be},{url1x:_e,url2x:Ie},{url1x:Re,url2x:Ce},{url1x:Ae,url2x:Te},{url1x:De,url2x:$e},{url1x:Ve,url2x:Ne}];let g;const re=document.querySelector(".projects-list");re&&Oe();async function Oe(){try{await fe(se,re),g=new q(".projects-swiper-container",{modules:[P,k],slidesPerView:1,spaceBetween:0,loop:!1,navigation:{nextEl:".projects-btn-next",prevEl:".projects-btn-prev"},keyboard:{enabled:!0,onlyInViewport:!0},speed:1e3,effect:"slide",on:{init:N,slideChange:N},touchEventsTarget:"wrapper",simulateTouch:!0,touchRatio:1,touchAngle:45})}catch(e){console.log(e.message)}}function N(){if(!g)return;const e=document.querySelector(".projects-btn-prev"),t=document.querySelector(".projects-btn-next");g.isBeginning?e.disabled=!0:e.disabled=!1,g.isEnd?t.disabled=!0:t.disabled=!1}function ze(e=[]){const t=(i=0)=>[...e.slice(i),...e.slice(0,i)].reduce((l,{url1x:m,url2x:y})=>l+`<li>        
  ...
  `}const He=async(e,t)=>{const s=ze(e);t.innerHTML="",t.insertAdjacentHTML("beforeend",s)},Fe=document.querySelector(".covers-marquee");He(se,Fe);const Ue=new IntersectionObserver(e=>{e.forEach(t=>{t.isIntersecting?t.target.classList.add("animate-covers"):t.target.classList.remove("animate-covers")})},{threshold:.5}),O=document.querySelector(".covers-section");O&&Ue.observe(O);function Ke(e=[]){return!e||e.length===0?"":e.reduce((t,{_id:s,author:o="Anonymous",avatar_url:r="default-avatar.png",review:n="No review provided"})=>t+`
      ...
      `}const ct=async(e,t)=>{const s=nt(e);t.innerHTML="",t.insertAdjacentHTML("beforeend",s)},it=e=>/^[\w.-]+@[a-zA-Z\d.-]+\.[a-zA-Z]{2,7}$/.test(e),lt="Escape",at=e=>{e.innerHTML=""};let f=document.querySelector(".modal-backdrop");f&&f.addEventListener("click",dt);let E;function ut(){f.classList.add("is-open"),window.addEventListener("keydown",ne),E=document.querySelector(".modal-close-btn"),E&&E.addEventListener("click",M)}function ne(e){e.code===lt&&M()}function dt(e){e.currentTarget===e.target&&M()}function M(e){window.removeEventListener("keydown",ne),f.classList.remove("is-open"),at(f)}document.addEventListener("DOMContentLoaded",Xe);const v=document.querySelector(".footer-form"),c=v.querySelector(".footer-email"),a=v.querySelector(".footer-comment"),pt=document.querySelector(".footer-button"),d=document.querySelector(".footer-email-error"),x=document.querySelector(".footer-comment-error"),W=document.querySelector(".js-footer-scroll-up");W&&W.addEventListener("click",()=>{h("id-hero",3e3)});const j=document.querySelector(".footer-email-success");v&&v.addEventListener("submit",ft);const mt=[c,a];mt.forEach(e=>{e&&(e.addEventListener("input",vt),e.addEventListener("input",B),e.addEventListener("keydown",Y),e.addEventListener("focus",Y))});async function ft(e){e.preventDefault();const t=K(c);if(!t){b(d,c);return}const s=K(a);if(!s){b(x,a);return}if(!it(t)){b(d,c);return}const o={email:t,comment:s};try{const r=await oe.post("requests",o);r&&r.status>=200&&r.status<300&&(await ct(r.data,document.querySelector(".modal-backdrop")),ut(),Z(c),Z(a),j&&j.classList.add("visible"),c&&c.classList.add("success"),v.reset())}catch{b(d,c)}finally{B()}}function B(){pt.disabled=!c.value.trim()||!a.value.trim()}function vt(){d&&d.classList.remove("visible"),x&&x.classList.remove("visible"),c&&c.classList.remove("error"),a&&a.classList.remove("error")}function Y(){d&&d.classList.remove("visible"),x&&x.classList.remove("visible"),j&&j.classList.remove("visible"),c&&c.classList.remove("error"),a&&a.classList.remove("error"),c&&c.classList.remove("success")}function b(e,t,s){e&&e.classList.add("visible"),t&&t.classList.add("error")}B();
